                                ...
                                if (h / _ > n / 2 + o.y) {
                                    ...
                                    b.each(l, (function(e) {
                                        ...
                                        i instanceof u.gG && (t *= i.value), t += e.get("marginBottom", 0), e.set("bounds", {
                                            ...
                                            right: s.x,
                                            bottom: x
                                        }), x = Math.min(x - t, e._fy - t), y.children.moveValue(e, 0)
                                    }))
                                } else {
                                    ...
                                    b.each(l, (function(e) {
                                        ...
                                        }), y.children.moveValue(e, 0), w = Math.max(w + t, e._fy + t)
                                    }))
                                }
                            }
                        }
                        ...
                        value: function(e, t) {
                            ...
                            if (null != l && null != u) {
                                ...
                                if (O.isType("CategoryAxis") && P.isType("CategoryAxis")) {
                                    var X = this._aLocationX0 + v - .5,
                                        S = this._aLocationX1 + f - .5;
                                    _ instanceof n.gG && (X += N = (S - X) * (1 - _.value) / 2, S -= N), h = P.getDataItemPositionX(e, d, X, M), c = P.getDataItemPositionX(e, r, S, M), X = this._aLocationY0 + y - .5, S = this._aLocationY1 + m - .5, x instanceof n.gG && (X += N = (S - X) * (1 - x.value) / 2, S -= N), p = O.getDataItemPositionY(e, g, X, I), b = O.getDataItemPositionY(e, o, S, I), e.setRaw("point", {
                                        x: h + (c - h) / 2,
                                        y: p + (b - p) / 2
                                    })
                                } else if (P === T) {
                                    if (X = this._aLocationX0 + v - .5, S = this._aLocationX1 + f - .5, _ instanceof n.gG && (X += N = (S - X) * (1 - _.value) / 2, S -= N), h = P.getDataItemPositionX(e, d, X, M), c = P.getDataItemPositionX(e, r, S, M), p = O.getDataItemPositionY(e, o, m, I), this._yOpenField !== this._yField) b = O.getDataItemPositionY(e, g, y, I);
                                    else if (w) {
                                    ...
                                    var N;
                                    if (X = this._aLocationY0 + y - .5, S = this._aLocationY1 + m - .5, x instanceof n.gG && (X += N = (S - X) * (1 - x.value) / 2, S -= N), p = O.getDataItemPositionY(e, g, X, I), b = O.getDataItemPositionY(e, o, S, I), c = P.getDataItemPositionX(e, r, f, M), this._xOpenField !== this._xField) h = P.getDataItemPositionX(e, d, v, M);
                                    else if (w) {
                        ...
                        value: function() {
                            ...
                            if (t.inited && i.inited) {
                                if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty || this.isDirty("connect") || this.isDirty("curveFactory")) {
                                    ...
                                    for (l > 0 && l--, this._endIndex = y, this._clearGraphics(), this._sindex = 0, this._dindex = l; this._dindex < y - 1;) this._startSegment(this._dindex), this._sindex++
                                }
                            } else this._skipped = !0;
                        ...
                        value: function(e) {
                            ...
                            for (k = e; k < a; k++) {
                                ...
                                var V = this._dataItems[k],
                                    G = V.get(m),
                                    U = V.get(v);
                                if (null == G || null == U ? n || (A = [], D.push(A), L.points = A) : this._getPoints(V, L), I) {
                                    ...
                                    if (l) {
                                        ...
                                        if (u) {
                                            ...
                                            b instanceof n.T && b.states.create("disabled", {
                                                fill: s,
                                                stroke: s
                                            }), b && (b.set("tooltipText", void 0), i.children.push(b), b.setAll({
                                                x: i.width() / 2,
                                                y: i.height() / 2
                                            }))
                                        }
