            ...
            var a = i(5125),
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "setupDefaultRules", {
                        ...
                        value: function() {
                            ...
                            i("PercentSeries").setAll({
                                ...
                                shiftRadius: 20
                            }), i("Slice", ["pie"]).states.create("hoverActive", {
                                scale: 1
                ...
                c = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        writable: !0,
                        value: function(t) {
                            e.prototype._processSeries.call(this, t), this.seriesContainer.children.moveValue(this.bulletsContainer, this.seriesContainer.children.length - 1)
                        }
                ...
                g = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "makeSlice", {
                        ...
                        value: function() {
                            ...
                            })), (this.isDirty("legendLabelText") || this.isDirty("legendValueText")) && f.each(this._dataItems, (function(e) {
                                    ...
                                    switch (a.label) {
                                        case 0:
                                            return r = [e.prototype.showDataItem.call(this, t, i)], d.isNumber(i) || (i = this.get("stateAnimationDuration", 0)), n = this.get("stateAnimationEasing"), l = t.get("value"), (s = t.animate({
                                                ...
                                                duration: i,
                                                easing: n
                                            })) && r.push(s.waitForStop()), (o = t.get("tick")) && r.push(o.show(i)), (u = t.get("label")) && r.push(u.show(i)), (c = t.get("slice")) && r.push(c.show(i)), c.get("active") && c.states.applyAnimate("active"), [4, Promise.all(r)];
                                        case 1:
                                            return a.sent(), [2]
                                    }
                                }))
                ...
                m = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        value: function() {
                            ...
                            })), (this.isDirty("innerRadius") || this.isDirty("radius")) && this.series.each((function(e) {
                ...
                O = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_makeSlices", {
                        ...
                        value: function() {
                            ...
                            if (i) {
                                if (this.isDirty("alignLabels")) {
                                    ...
                                    if (this.get("alignLabels")) a.set("textType", "aligned");
                                    else {
                                        var r = a.get("textType");
                                        null != r && "aligned" != r || a.set("textType", "adjusted")
                                    }
                                }
                                if (this._valuesDirty || this.isDirty("radius") || this.isDirty("innerRadius") || this.isDirty("startAngle") || this.isDirty("endAngle") || this.isDirty("alignLabels")) {
                                    ...
                                    var n = this.get("startAngle", i.get("startAngle", -90)),
                                        s = this.get("endAngle", i.get("endAngle", 270)) - n,
                                        o = n,
                                        u = i.radius(this);
                                    this.setPrivateRaw("radius", u);
                                    var c = i.innerRadius(this) * i.getPrivate("irModifyer", 1);
                                    c < 0 && (c = u + c), u > 0 && f.each(this._dataItems, (function(e) {
                                        t.updateLegendValue(e);
                                        var i = s * e.get("valuePercentTotal") / 100,
                                            a = e.get("slice");
                                        if (a) {
                                            a.set("radius", u), a.set("innerRadius", c), a.set("startAngle", o), a.set("arc", i);
                                            var r = e.get("fill");
                                            a._setDefault("fill", r), a._setDefault("stroke", r)
                                        }
                                        var n = v.normalizeAngle(o + i / 2),
                                            h = e.get("label");
                                        if (h && (h.setPrivate("radius", u), h.setPrivate("innerRadius", c), h.set("labelAngle", n), "aligned" == h.get("textType"))) {
                                            var b = u + h.get("radius", 0),
                                                p = u * v.sin(n);
                                            n > 90 && n <= 270 ? (h.isHidden() || h.isHiding() || t._lLabels.push({
                                                label: h,
                                                y: p
                                                ...
                                                label: h,
                                                y: p
                                            }), b += t.labelsContainer.get("paddingRight", 0), h.set("centerX", 0), h.setPrivateRaw("left", !1)), h.set("x", b), h.set("y", u * v.sin(n))
                                        }
                                        o += i, t._updateTick(e)
                                    }))
                                }
                        ...
                        value: function(e) {
                            var t = e.get("sprite");
                            if (t) {
                                var i = t.dataItem.get("slice");
                                if (i) {
                                    var a = i.get("innerRadius", 0),
                                        r = i.get("radius", 0),
                                        n = i.get("startAngle", 0) + i.get("arc", 0) * e.get("locationX", .5),
                                        l = a + (r - a) * e.get("locationY", .5);
                                    t.setAll({
                                        x: v.cos(n) * l,
                                        y: v.sin(n) * l
                                    })
                            ...
                            if (t) {
                                ...
                                if (i) {
                                    var a = i.width(),
                                        ...
                                        s = 0,
                                        o = 0;
                                    "horizontal" == this.get("orientation") ? o = r / 2 : s = a / 2, t.setAll({
                                        x: i.x() + a * n - s,
                                        y: i.y() - o + r * l
                                    })
                                }
                ...
                A = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_prepareChildren", {
                        ...
                        writable: !0,
                        value: function(e) {
                            var t, i, r, n, s = this.get("orientation"),
                            ...
                            if (0 != p) {
                                var f, g, v = this.get("startLocation", 0),
                                ...
                                var L = y.relativeToValue(w, O),
                                    S = this._nextSize,
                                    N = Math.atan2(k, D - L),
                                    I = Math.tan(Math.PI / 2 - N);
                                if (0 == I && (I = 1e-8), "area" == b) {
                                    var R = (D + L) / 2 * k * P / p,
                                        M = Math.abs(S * S - 2 * R * I);
                                    g = (f = (S - Math.sqrt(M)) / I) > 0 ? (2 * R - f * S) / f : S
                                } else g = S - (f = k * P / p) * I;
                                ...
                                "vertical" == s ? (c.set("y", W), c.get("opacity") > 0 && this._rLabels.push({
                                    ...
                                    label: c,
                                    y: W
                                }), z = (r = (0, a.CR)([V, z], 2))[0], V = r[1], H = (n = (0, a.CR)([F, H], 2))[0], F = n[1], u.set("width", f)), u.setAll({
                                    orientation: s,
                                    bottomWidth: g,
                                    topWidth: S,
                                    x: z,
