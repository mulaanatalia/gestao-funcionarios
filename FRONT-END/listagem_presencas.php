...
<body class="text-left">
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1 class="font-weight-bold">Marcar Presenças</h1>
                    <!-- <ul>
                        <li><a href="#">Home</a></li>
                        <li>Buttons</li>
                    </ul> -->
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <!--<div class="col-md-4 mb-3">
                                        <label for="" style="font-family: 'Arial narrow'; font-size: 14px; color: #2C304D; font-weight: 600;">Data da presença</label>
    ...
    <script>
             ...
             $(document).on("click", ".presenca_entrada", function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: './app/ajax/presenca/create.php',
                            method: 'POST',
                            data: {
        ...
        $(document).on("click", ".presenca_saida", function() {
                // alert($(this).val())
                // alert($(this).attr("funcionario_nome"))
                Swal.fire({
                    title: 'Tem certeza?',
                    text: "Ao confirmar ira marcar a presenca de saida para "+$(this).attr("funcionario_nome"),
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: './app/ajax/presenca/update.php',
                            method: 'POST',
                            data: {
                                "funcionario_id": $(this).val(),
        ...
        //         });
        //     })
             $("#registar_presenca").click(function() {
                // alert($("#depart").val())
                $.ajax({
                    url: './app/ajax/presenca/create.php',
                    method: 'POST',
        ...
        function list(page) {
            ...
            showLoader();
            $.ajax({
                url: './app/ajax/presenca/list.php',
                method: 'GET',
                data: { 
                     "nome": $("#nome").val(),
                     "data": $("#data").val(),
