...
// get the HTML
ob_start();
include('./res/ver_htmlFichaAluno.php');
...
<small><div><label style="text-align=left; font-weight: bold;" class="h6">&copy; Copyright <strong style="font-weight: bold;">ITS <img src="#" alt="" style="width: 10px; height: 10px; text-align: left; margin-top: 200px; "> </strong></label></div> <div style="text-align: right">{PAGENO} of {nbpg}</div></small>');
